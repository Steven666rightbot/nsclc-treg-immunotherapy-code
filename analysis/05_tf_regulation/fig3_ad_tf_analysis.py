...
# Paths
# ============================================================
BASE_DIR = 'D:/research/tomato'
TF_ACT_PATH = os.path.join(BASE_DIR, 'results/scenic_input/dorothea_tf_activity.csv')
META_PATH = os.path.join(BASE_DIR, 'results/scenic_input/treg_no_foxp3_metadata.csv')
OUT_FIG_DIR = os.path.join(BASE_DIR, 'figures')
OUT_RESULTS_DIR = os.path.join(BASE_DIR, 'results')
